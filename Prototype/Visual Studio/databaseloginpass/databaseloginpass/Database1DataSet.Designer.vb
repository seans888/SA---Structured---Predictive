...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Username], [Password]) VALUES (@Username, @Password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Username, Password FROM [User] WHERE (Username = @Username)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[User] SET [Username] = @Username, [Password] = @Password WHERE (([U"& _ 
                "sername] = @Original_Username) AND ([Password] = @Original_Password));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT U"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.databaseloginpass.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Username, Password FROM dbo.[User]"
